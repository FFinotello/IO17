...
# -- Two time points (or additional steady state)
t = c(10, 30)
...
# -- Synchronous multiple time point simulation with CNORdt
...
# -- Constrained fuzzy logic with CNORfuzzy
